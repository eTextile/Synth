...
void mapping_touchpad_continue(blob_t* blob_ptr) {
  ...
  mapping_send_midi_pos_x_msg(&touchpad_ptr->params.rect, &touch_ptr->pos_x, blob_ptr);
  mapping_send_midi_pos_y_msg(&touchpad_ptr->params.rect, &touch_ptr->pos_y, blob_ptr);
