/*
   ...
   to upload files, we can't just throw out debug information.  Instead, we use the LED_PIN
    to convey state.

   While the chip is being formatted, the LED will toggle at 1Hz rate.  When
